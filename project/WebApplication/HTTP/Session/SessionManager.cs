...
namespace Es.Udc.DotNet.PracticaMaD.Web.HTTP.Session
{
    ...
    public class SessionManager
    {
        ...
        public IFeedUserService FeedUserService
        {
            set { feedUserService = value; }
        }
        public IPostService PostService
        {
            set { postService = value; }
        }
        ...
        static SessionManager()
        {
            ...
            feedUserService = iocManager.Resolve<IFeedUserService>();
            postService = iocManager.Resolve<IPostService>();
        ...
        public static void Login(HttpContext context, String loginName,
           String clearPassword, Boolean rememberMyPassword, bool isAuth20)
        {
        ...
        public static FeedUserDetails findFeedUserDetails(HttpContext context)
        {
            ...
            FeedUserDetails feedUserDetails =
                feedUserService.FindFeedUserDetails(userSession.UserProfileId, 0, size);
